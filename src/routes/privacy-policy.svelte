...
<p>
  At pstouchapk, accessible from https://pstouchapk.com, one of our main
  priorities is the privacy of our visitors. This Privacy Policy document
  contains types of information that is collected and recorded by pstouchapk and
  how we use it.
</p>
...
<p>
  pstouchapk follows a standard procedure of using log files. These files log
...
<p>
  Like any other website, pstouchapk uses 'cookies'. These cookies are used to
...
<p>
  ...
  and links that appear on pstouchapk, which are sent directly to users'
...
<p>
  Note that pstouchapk has no access to or control over these cookies that are
...
<p>
  pstouchapk's Privacy Policy does not apply to other advertisers or websites.
...
<p>
  pstouchapk does not knowingly collect any Personal Identifiable Information
...
<p>
  ...
  and/or collect in pstouchapk. This policy is not applicable to any information
